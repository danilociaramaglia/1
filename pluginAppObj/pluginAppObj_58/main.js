function justifiedgallery_pluginAppObj_58() {
	var $gallery,
        grid = "",
        loaders = [],
        loadingTimeout,
	...
	x5engine.boot.push(function(){
        ...
        grid = $("#jg_pluginAppObj_58 .jg-container");
		$gallery = $('#jg_pluginAppObj_58 .jg-container').justifiedGallery({
			rowHeight : 1000,
			margins : 0,
        ...
        if ("online" !== 'uipreview'){    
            x5engine.utils.onElementInViewPort($("#jg_pluginAppObj_58 .jg-container")[0],loadImage,$("#jg_pluginAppObj_58 .jg-container .grid-item .item-img:lt(1)").height() /3);
        }
        else {
            loadImage();
        }
	...
	function create_showbox(){
        $("#jg_pluginAppObj_58 .grid-item.showbox").off("click.sb");
        $("#jg_pluginAppObj_58 .grid-item.showbox").on("click.sb", function(e) { 
            var starting_index = parseInt($(this).attr("data-index"),10);
            var images = ['pluginAppObj/pluginAppObj_58/copiajb_sb.jpg'];var imagesDescriptions = [""];
            var medias = [];
    ...
    function resized_pluginAppObj_58(){
        $('#jg_pluginAppObj_58 .grid-item').each(function(){
    ...
    GridLoaderFx.prototype._render = function () {
        ...
        if (effectSettings.lineDrawing != undefined) {
            ...
            animeLineDrawingOpts.targets = document.querySelectorAll('#jg_pluginAppObj_58 .jg-container .grid__deco > path');
        ...
        if (effectSettings.revealer != undefined) {
            ...
            animeRevealerOpts.targets = document.querySelectorAll('#jg_pluginAppObj_58 .jg-container .grid__reveal');
        ...
        animeOpts.targets = effectSettings.sortTargetsFn && typeof effectSettings.sortTargetsFn === 'function' ? [].slice.call(this.items).sort(effectSettings.sortTargetsFn) : document.querySelectorAll("#jg_pluginAppObj_58 .jg-container .item-img");
    ...
    function animeComplete(anim) {
        if (anim.completed)
            $("#jg_pluginAppObj_58 .jg-container .grid-item img.item-img").removeClass("back-show").addClass("no-show");
    }
